  ...
  return (
    <>
      <Box classes={{ root: classes.mainWrapper }}>
          ...
          <Box className={menuDisplay}>
            ...
            >
              ...
              <Tab
                ...
                icon={
                  <img
                    src="./svg/college-graduation.svg"
                    alt="User Icon"
                    className={classes.tabIcon}
                  />
                }
              ...
              <Tab
                ...
                className={
                  classes.tab + " " + classes.capitalize + " " + classes.lastTab
                }
              />
            </Tabs>
          </Box>
        ...
        <Box
          className={classes.mainWrapper + " " + classes.bgWhite}
          px="1rem"
          py="1.75rem"
        >
          <Box className={classes.sectionPerfil + " " + classes.perfil}>
            ...
            >
              <Typography
                className={classes.primaryTitle + " " + classes.title}
                variant="h4"
              >
                Perfil
              </Typography>
            ...
            <Box
              className={classes.mainWrapper + " " + classes.inputWrapper}
              mb=".5rm"
            >
              <Typography
            ...
            >
              ...
              <GenericInput
                className={classes.input}
                type="email"
                placeholder="quieroseractor@gmail.com"
              />
            </Box>
            <Box
              className={classes.mainWrapper + " " + classes.inputWrapper}
            ...
            >
              ...
              <GenericInput
                className={classes.input}
                type="text"
                placeholder="Av. Francia 2340. Casa blanca"
              />
            </Box>
            <Box display="flex" my="1rem">
              <Button className={classes.saveButton}>Guardar</Button>
              <Button
                className={classes.cancelButton + " " + classes.capitalize}
              >
                Cancelar
              </Button>
            </Box>
          ...
          <Box className={classes.sectionCalificaciones}>
            <Box
              className={classes.calificaciones}
              borderBottom="1px solid #808080"
              mt="2.25rem"
              mb="1.25rem"
              pb=".75rem"
            ...
            <Box>
              <Typography
                className={classes.title + " " + classes.secondaryTitle}
                variant="h5"
              >
                Promedio:
              </Typography>
            ...
            <Box>
              <Typography
                className={classes.secondaryTitle + " " + classes.title}
                variant="h5"
              >
                Comentarios:
              </Typography>
